...
class Character(Entity):
    def __init__(self, x, y, sprite_path="PLAYER"):
        super().__init__(x, y, SPRITES[sprite_path], SPRITES["OUTLINE_GREEN"])
    ...
    def attack(self, target):
        damage = self.combat_stats.damage * random.uniform(0.8, 1.2)
        target.health -= max(0, damage - target.combat_stats.armor)
